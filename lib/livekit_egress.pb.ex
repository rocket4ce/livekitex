...
defmodule Livekit.EgressService.Service do
  @moduledoc false

  use GRPC.Service, name: "livekit.EgressService", protoc_gen_elixir_version: "0.14.0"
...
defmodule Livekit.EgressService.Stub do
  @moduledoc false

  use GRPC.Stub, service: Livekit.EgressService.Service
end
